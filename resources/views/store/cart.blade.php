...
<!--                            -->
                ...
                <div class="payment-method">
                    <div class="input-radio">
                        ...
                        <div class="caption">
                            <p>Produk akan dikirimkan setelah konfirmasi pembayaran.</p>
                        </div>
                    </div>
                    <div class="input-radio">
        ...
        <form method="post" id="signupForm">
            ...
            <div class="col-md-7">
                ...
                <div class="billing-details">
                    ...
                    <div class="form-group">
                        <input class="input" type="text" name="address" id="address" placeholder="Alamat Lengkap">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input class="input" type="tel" name="tel" id="tel" placeholder="Nomor HP">
                    </div>
                    <div class="form-group">
                        <input class="input" type="password" name="pass" id="pass" placeholder="Masukan Password">
                    </div>
                    <div class="form-group">
